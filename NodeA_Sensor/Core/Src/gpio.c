...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_NOTICE_Pin|LED_WARNING_Pin|LED_SAFE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SR04_Trig_GPIO_Port, SR04_Trig_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_NOTICE_Pin LED_WARNING_Pin LED_SAFE_Pin */
  GPIO_InitStruct.Pin = LED_NOTICE_Pin|LED_WARNING_Pin|LED_SAFE_Pin;
